...
export default function CronPage() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full overflow-hidden">
      {/* Header */}
      <div className="flex-shrink-0 flex items-center justify-between px-4 py-2 border-b border-zinc-800 bg-zinc-950/80 backdrop-blur-sm">
      ...
      <div className="flex-1 overflow-y-auto">
        {loading ? (
          <div className="p-6 text-xs font-mono text-zinc-600">loading...</div>
